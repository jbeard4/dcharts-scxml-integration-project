"""
__DChartsDebugServer_CD_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: jacob
Modified: Wed Oct 27 11:30:07 2010
...
def DChartsDebugServer_CD_MDL(self, rootNode, ClassDiagramsV3RootNode=None):

    # --- Generating attributes code for ASG ClassDiagramsV3 ---
    if( ClassDiagramsV3RootNode ): 
        # name
        ClassDiagramsV3RootNode.name.setValue('DChartsDebugServer')
        ...
        # description
        ClassDiagramsV3RootNode.description.setValue('This formalism has only one button, which is to start an HTTP server for remotely animating DCharts.\n')
    ...
    self.obj24.Graphical_Appearance.setValue( ('Class_0', self.obj24))
    ...
    if self.genGraphics:
       new_obj = graph_Class3(160.0,160.0,self.obj24)
...
newfunction = DChartsDebugServer_CD_MDL
